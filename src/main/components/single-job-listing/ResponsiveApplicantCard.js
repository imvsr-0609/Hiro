...
const ResponsiveApplicantCard = ({
	...
	return (
		<div className="  bg-white shadow-outer rounded-2xl p-4  flex flex-col  gap-6 relative ">
			{verified !== 'PENDING' && (
							...
							{email !== null && email !== '' ? (
								<>
									{eligible ? (
										...
										<ArrowTooltip title={'Not enough credits'}>
				...
				<div className="shadow border max-h-48 p-4 flex w-1/2 flex-col gap-3 mt-1 h-full rounded-2xl">
					<div className="flex flex-col  gap-1 w-full ">
						<p className="text-xs text-left capitalize font-semibold">
							Technical Skills ({skilltable_technical_score?.toFixed(2) ?? 0}
							%)
						</p>
					...
					<div className="flex flex-col  gap-1 w-full ">
						<p className="text-xs text-left capitalize font-semibold">
							Management Skills ({skilltable_management_score?.toFixed(2) ?? 0}
							%)
						</p>
						<div className="w-full h-2 relative bg-gray-100   rounded-full shadow overflow-hidden ">
							<div
			...
			{user_summary && (
				<div className="w-full break-words">
					...
					<p>
						{/* {ReactHtmlParser(
							showMoreSummary ? user_summary : user_summary.split('\n')[1],
						)} */}
						{showMoreSummary
			...
			<div className="flex flex-col md:flex-row gap-6">
				<div className="shadow border p-4 flex flex-col gap-3 h-full md:w-1/2 rounded-2xl relative ">
					<ArrowTooltip
						title={
					...
					<div className="flex flex-col p-4 rounded-2xl shadow border  flex-1">
						<div className="flex flex-col gap-2 flex-1">
							<div className="flex justify-between items-start gap-2">
								...
								>
									<BsGithub />
									<p className="text-base font-semibold">@{github_profile}</p>
								</Link>

								<div className="flex flex-col gap-1  items-start">
									<p className="text-sm text-blue-500 text-left capitalize font-semibold flex gap-1 items-center">
										<AiOutlineLineChart />
										{ranking !== 'NA' ? ranking : ''}
									</p>
...
export default ResponsiveApplicantCard;
